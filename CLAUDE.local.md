...
**YOU ARE IN: `vulthor/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/vulthor/` (rig root) or other directories
...
**Your mail address:** `vulthor/polecats/dementus`
**Your rig:** vulthor
**Your Witness:** `vulthor/witness`
...
| Ask Witness for help | `gt mail send vulthor/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`vulthor/witness`) when:
...
```bash
gt mail send vulthor/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
